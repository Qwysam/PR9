...
public class nUnitClass6
{
    ...
    private void changeFilterTest()
    {
        var ButtonFilter = driver.FindElement(By.XPath("/html/body/div/div/div/div[1]/div[2]/div/span/select"));
        ButtonFilter.Click();
        Thread.Sleep(1000);
        var lowToHighFilter = driver.FindElement(By.XPath("/html/body/div/div/div/div[1]/div[2]/div/span/select/option[3]"));
